...
if __name__ == '__main__':
    ...
    for index in range(IMG_NUMBERS):
                                    ...
                                    if min(y111, y222) > max(y1, y2, y11, y22):
                                        if check_hor_length(i, j, k):
                                            if check_collision_point_placement(x1, x2, y1, y2, x11, x22, y11, y22, x111,
                                                                               x222, y111, y222):
                                                if (len_of_line(y11, y1, x11, x1) < len_of_line(y22, y2, x22, x2)):
                                                    ...
                                                    if best_result is None:
                                                        ...
                                                        sum_len = len_of_line(y2, y1, x2, x1) + len_of_line(y22, y11,
                                                                                                            x22,
                                                                                                            x11)
                                                        best_x1 = x1
                                                        best_x2 = x2
                                                        ...
                                                        new_sum = len_of_line(y2, y1, x2, x1) + len_of_line(y22, y11,
                                                                                                            x22,
                                                                                                            x11)
                                                        if new_sum == sum_len:
        ...
        path = "C:/Users/MooNice/Desktop/Edge_Detection/1/finding_pip/find_exact_pipe_5"
        print(index + 1)
        cv2.imwrite(os.path.join(path, f'result{index + 1}.jpg'), img_real_hor)
